...
agent = the_agent.Agent(possible_actions=[0,2,3],starting_mem_len=50000,max_mem_len=750000,starting_epsilon = 1, learn_rate = .1) #0.00025
...
agent.epsilon = 0.2 #0.9996939999999988
...
for i in range(1000000):
    ...
    """if i % 49 == 0:
            agent.memory = agent_memory.Memory(50000)"""
